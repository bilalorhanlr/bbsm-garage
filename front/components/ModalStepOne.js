...
import './Wizard.js';
import './ModalStepTwo.js';


const ModalStepOne = ({  isOpen, onClose, onNext }) => {
        ...
        <div className="bg-white rounded-3xl max-w-2xl w-full mx-4 md:mx-0" onClick={e => e.stopPropagation()}>
          ...
          <div className="p-12 pl-16 pr-16">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <input type="number" id="telNo" placeholder="\d{10}" value={telNo} onChange={e => setTelNo(e.target.value)} className="bg-my-beyaz border p-2 rounded-md" />
              ...
              <input type="date" id="girisTarihi" placeholder="Giriş Tarihi" value={girisTarihi} onChange={e => setDatee(e.target.value)} className="bg-my-beyaz border p-2 rounded-md" />
