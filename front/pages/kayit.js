      ...
      <div className="absolute inset-0 flex items-center justify-center">
        ...
        <h1 className="p-4 font-extrabold text-transparent text-3xl bg-clip-text bg-gradient-to-r from-my-açıkgri to-my-beyaz">BBSM GARAGE</h1>
          ...
          <div className="text-center w-full">
            <p className="w-full text-2xl p-1 font-thin mb-4 rounded-xl text-my-beyaz bg-my-4b4b4bgri border border-my-açıkgri">https://www.bbsm.tech</p>
            <p className="w-full text-2xl p-1 font-thin mb-4 rounded-xl text-my-beyaz bg-my-4b4b4bgri border border-my-açıkgri">info@bbsm.tech</p>
